...
"""
Processor class for VibePod models.
"""
...
# Import the base feature extractor instead of ProcessorMixin
...
class AudioNormalizer:
    """
    Audio normalization class for VibePod tokenizer.
    
    This class provides audio normalization to ensure consistent input levels
    for the VibePod tokenizer while maintaining audio quality.
    """
...
class VibePodTokenizerProcessor(FeatureExtractionMixin):
    ...
    This processor handles audio preprocessing for VibePod models, including:
    ...
    def __call__(
        ...
        **kwargs,
        ...
        """
        Process audio for VibePod models.
    ...
    def _load_audio_from_path(self, audio_path: str) -> np.ndarray:
        ...
        try:
            ...
            raise ImportError(
                "librosa is required to load audio from file paths. "
