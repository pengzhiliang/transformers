...
"""Tokenization classes for VibePod."""
...
class VibePodTextTokenizer(Qwen2Tokenizer):
    """
    Construct a VibePod tokenizer. Based on the Qwen2 tokenizer with additional special tokens for speech.
    ...
    Args:
        ...
        bos_token (`str`, *optional*):
            The beginning of sequence token. Not used for VibePod.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Add VibePod-specific special tokens
        self._add_vibepod_special_tokens()
        
    def _add_vibepod_special_tokens(self):
        """Add VibePod-specific special tokens."""
        special_tokens = {
...
class VibePodTextTokenizerFast(Qwen2TokenizerFast):
    """
    Construct a "fast" VibePod tokenizer (backed by HuggingFace's *tokenizers* library).
...
__all__ = ["VibePodTextTokenizer", "VibePodTextTokenizerFast"]